<template>
  <v-container>
    <v-row justify="space-around">
      <v-col cols="12" md="8">
        <h4 class="py-6 text-h4 text-center" color="primary ">
          Resumo do Teste
        </h4>
        <v-card>
          <v-row class="ma-0">
            <v-col cols="12" md="6">
              <v-list>
                ...
                <v-list-item class="d-flex align-center">
                  ...
                  <v-list>
                    <v-list-item class="d-flex align-center">
                      Inicio : {{ test.config.date.start }}
                    </v-list-item>
                    <v-list-item class="d-flex align-center">
                      Fim : {{ test.config.date.finish }}
                    </v-list-item>
                  </v-list>
                </v-list-item>
              </v-list>
            ...
            <v-col cols="12" md="6">
              <v-list>
                <v-list-item class="d-flex align-center">
                  Numero de Questoes :
                  {{
                    parseInt(test.config.number_questions) +
                      parseInt(test.compromises.number_questions)
                  }}
                </v-list-item>
                ...
                <v-list-item class="d-flex align-center">
                  Maximo de Opcoes por Questoes :
                  {{ test.config.maximum_displayed_answers }}
                </v-list-item>

                <v-list-item class="d-flex align-center">
                  Tempo de realizacao :
                  {{ parseInt(test.config.total_time) + " min" }}
                </v-list-item>
