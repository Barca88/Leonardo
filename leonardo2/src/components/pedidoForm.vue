...
export default {
  ...
  methods:{
        ...
        post(){
            axios.get(`https://leonardo2.di.uminho.pt/api/users/pedidos/mover/` + this.pedido.username + `?nome=` + this.pedido.username,{ headers: { Authorization: `Bearer: ${this.$store.state.jwt}` } })
            .then(response => {
