...
export default {
    ...
    created: function(){
        axios.get(`https://leonardo2.di.uminho.pt/api/folios/folios?nome=${this.$store.state.user._id}`,{headers:{
        ...
        axios.get(`https://leonardo2.di.uminho.pt/api/folios/compFolios/pesquisas?nome=${this.$store.state.user._id}`,{
            headers: {
                Authorization: `Bearer: ${this.$store.state.jwt}`       
            }
        }).then(data => {
    ...
    methods:{
        ...
        pesquisa:function(){
            ...
            axios.post(`https://leonardo2.di.uminho.pt/api/folios/compFolios/post?nome=${this.$store.state.user._id}`,formData,{
                headers: {
