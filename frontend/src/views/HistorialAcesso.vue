...
export default {
    ...
    created: async function() {
        //Active
        axios.get(`${process.env.VUE_APP_BACKEND}/users/history`, { headers: { Authorization: `Bearer: ${this.$store.state.jwt}` } })
        .then(response => {
    ...
    methods:{
        eliminarHistorico:function(){
            axios.get(`${process.env.VUE_APP_BACKEND}/users/historyCleanse`, { headers: { Authorization: `Bearer: ${this.$store.state.jwt}` } })
            .then(response => {
