...
<script>
import ButtonMenu from "@/tests_modulo/components/Preparation/ButtonMenu";
import ConfigForm from "@/tests_modulo/components/Preparation/ConfigForm";
import QuestionSelectForm from "@/tests_modulo/components/Preparation/QuestionSelectForm";
...
import * as generatorApi from "@/tests_modulo/utils/api/generator";
...
export default {
  ...
  methods: {
    clearAll() {
      if (this.$route.query.editing) this.$router.push("/tests/preparation");
